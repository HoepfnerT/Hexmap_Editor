...
def handle_event(event, MAP_HANDLER, GAME_RECT):
    if event.type == pygame.KEYDOWN:
        ...
        # place/delete hex with keys
            ...
            if MAP_HANDLER.get_select():    MAP_HANDLER.set_tiles_on_map(list(MAP_HANDLER.get_select_tile()), 0)
        elif event.key == pygame.K_0 or event.key == pygame.K_KP0: 
            if MAP_HANDLER.get_select():    MAP_HANDLER.set_tiles_on_map(list(MAP_HANDLER.get_select_tile()), 0)
        elif event.key == pygame.K_1 or event.key == pygame.K_KP1: 
            if MAP_HANDLER.get_select():    MAP_HANDLER.set_tiles_on_map(list(MAP_HANDLER.get_select_tile()), 1)
        elif event.key == pygame.K_2 or event.key == pygame.K_KP2: 
            if MAP_HANDLER.get_select():    MAP_HANDLER.set_tiles_on_map(list(MAP_HANDLER.get_select_tile()), 2)
        elif event.key == pygame.K_3 or event.key == pygame.K_KP3: 
            if MAP_HANDLER.get_select():    MAP_HANDLER.set_tiles_on_map(list(MAP_HANDLER.get_select_tile()), 3)
        elif event.key == pygame.K_4 or event.key == pygame.K_KP4: 
            if MAP_HANDLER.get_select():    MAP_HANDLER.set_tiles_on_map(list(MAP_HANDLER.get_select_tile()), 4)
        elif event.key == pygame.K_5 or event.key == pygame.K_KP5: 
            if MAP_HANDLER.get_select():    MAP_HANDLER.set_tiles_on_map(list(MAP_HANDLER.get_select_tile()), 5)
        elif event.key == pygame.K_6 or event.key == pygame.K_KP6: 
            if MAP_HANDLER.get_select():    MAP_HANDLER.set_tiles_on_map(list(MAP_HANDLER.get_select_tile()), 6)
        elif event.key == pygame.K_7 or event.key == pygame.K_KP7: 
            if MAP_HANDLER.get_select():    MAP_HANDLER.set_tiles_on_map(list(MAP_HANDLER.get_select_tile()), 7)
        elif event.key == pygame.K_8 or event.key == pygame.K_KP8: 
            if MAP_HANDLER.get_select():    MAP_HANDLER.set_tiles_on_map(list(MAP_HANDLER.get_select_tile()), 8)
        elif event.key == pygame.K_9 or event.key == pygame.K_KP9: 
            if MAP_HANDLER.get_select():    MAP_HANDLER.set_tiles_on_map(list(MAP_HANDLER.get_select_tile()), 9)
